...
nV, nC = testUtility.calculate_nVnC([])
...
# refactored into testUtility
supply = testUtility.createSupply(box, player_names, nC, nV)

# initialize the trashg
trash = []
# Construct the Player objects,  refactored into testUtility
